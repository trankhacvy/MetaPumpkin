...
const description =
  "Meta Pumpkin are a collection of 147 randomly generated and unique creatures living on the BSC blockchain in the form of ERC-721 tokens";
...
const CommonSEO = () => {
  ...
  return (
    <Head>
      ...
      <meta name="twitter:image" content={`${process.env.APP_URL}/twitter-card.png`} />
    </Head>
  );
};
