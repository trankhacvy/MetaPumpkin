...
import pumpkinAbi from "../contracts/Pumpkin.json";
...
export const PUMBKIN_CONTRACT = process.env.METAPUMPKIN_CONTRACT_ADDRESS;
...
export const usePumbkinContract = () => {
  return useContract(PUMBKIN_CONTRACT, pumpkinAbi);
};
